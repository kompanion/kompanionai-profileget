"""AWS Lambda function handler for Kompanion ProfilePost function"""
...
def lambda_handler(event, context):
    ...
    region = 'us-east-2'
    userpool_id = 'us-east-2_util3hX7I'
    ...
    obj = s3.Object('kompanionai-profiles', username + '/profile.json.gz')
    ...
    # read user's current context 
    obj = s3.Object('kompanionai-chats', username + '/currentcontext.json.gz')
    with gzip.GzipFile(fileobj=obj.get()['Body']) as gzipfile:
        currentcontext = json.loads(gzipfile.read())
    ...
    return {
        ...
        "body": json.dumps({
            ...
            "message": "Kompanion User Profile Successfully Fetched"
        }),
    }
